"""
Fetch the newest file from an FTP server and save it locally for Kasipet.

Defaults are chosen for a Kasipet deployment, but all settings can be
...
DEFAULT_LOCAL_DIR = Path("kasipet_fetcher") / "downloads"
DEFAULT_FILENAME_PREFIX = "kasipet_"
