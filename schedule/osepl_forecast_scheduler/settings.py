"""Configuration for the OSEPL forecast scheduler package."""
...
# OSEPL runs a 3-hour rolling horizon from each revision time.
FORECAST_HORIZON_HOURS = _env_int("OSEPL_FORECAST_HORIZON_HOURS", 3)
FORECAST_BLOCKS = _env_int(
    "OSEPL_FORECAST_BLOCKS",
    max(1, FORECAST_HORIZON_HOURS * 60 // config.BLOCK_MINUTES),
)

# S3 layout used by the scheduler package.
DEFAULT_S3_RAW_OWNER = "vedanjay"
DEFAULT_S3_PLANT_FOLDER = "OSEPL"
...
ECMWF_TILT_DEGREES = _env_int("OSEPL_ECMWF_TILT_DEGREES", 14)
ECMWF_AZIMUTH_DEGREES = _env_int("OSEPL_ECMWF_AZIMUTH_DEGREES", 180)
