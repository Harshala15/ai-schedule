"""AWS Lambda entry point for the OSEPL forecast scheduler."""

from __future__ import annotations

import os

from osepl_forecast_scheduler import settings
from osepl_forecast_scheduler.scheduler_service import run_schedule_job
...
def lambda_handler(event, context):
    bucket = _pick("S3_BUCKET", "ai-forecasting-storage-429694361053")
    if not bucket:
