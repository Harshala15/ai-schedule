"""
AWS Lambda entry point for the Kothagudem FTP fetcher.

Uploads the newest file from the Kothagudem FTP source into:
    raw/vedanjay/KOTHAGUDEM/YYYY-MM-DD/meter_data/<filename>
"""
...
from kothagudem_fetcher.fetch_latest_ftp import FTPConfig, download_latest_file


DEFAULT_S3_PREFIX_BASE = "raw/vedanjay/KOTHAGUDEM"
...
def lambda_handler(event, context):
    ...
    local_path, remote_path, mtime = download_latest_file(config, local_dir=LOCAL_TMP_DIR)
