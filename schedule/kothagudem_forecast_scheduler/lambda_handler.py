"""AWS Lambda entry point for the Bhupalpally forecast scheduler."""

from __future__ import annotations

import os

from kothagudem_forecast_scheduler import settings
from kothagudem_forecast_scheduler.scheduler_service import run_schedule_job
