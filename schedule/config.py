...
MAX_CLEAR_PEAK_AC_FRACTION = _read_env_float("MAX_CLEAR_PEAK_AC_FRACTION", 0.85)
AFTERNOON_THERMAL_HYSTERESIS_FACTOR = _read_env_float("AFTERNOON_THERMAL_HYSTERESIS_FACTOR", 0.94)
SCADA_TELEMETRY_DECAY_TAU_MINUTES = _read_env_float("SCADA_TELEMETRY_DECAY_TAU_MINUTES", 75.0)
