"""
AWS Lambda entry point for the Bhupalpally FTP fetcher.

Uploads the newest file from the Bhupalpally FTP source into:
...
from bhupalpally_fetcher.fetch_latest_ftp import FTPConfig, download_latest_file


DEFAULT_S3_PREFIX_BASE = "raw/vedanjay/BHUPALPALLY"
...
def _build_ftp_config() -> FTPConfig:
    ...
    filename_prefix = pick("SFTP_FILENAME_PREFIX", "bhupalpally_")
