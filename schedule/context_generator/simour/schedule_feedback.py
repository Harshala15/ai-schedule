...
bootstrap_environment("SIRMOUR")

from modules.feedback import daily_feedback  # noqa: E402


def main() -> None:
    parser = argparse.ArgumentParser(description="Build SIRMOUR context from schedule CSV + actual meter CSV.")
    ...
    entry = daily_feedback.process_schedule_feedback(
        ...
        source_label="sirmour schedule feedback",
    )
